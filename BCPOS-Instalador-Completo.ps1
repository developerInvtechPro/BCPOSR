# =====================================================
# BCPOS - INSTALADOR EJECUTABLE COMPLETO
...
$GITHUB_URL = "https://github.com/tu-usuario/bcpos/archive/refs/heads/main.zip"
$PROJECT_NAME = "BCPOS"
...
# Mostrar bienvenida
$welcomeMessage = @"
🚀 INSTALADOR COMPLETO BCPOS

Este instalador hará TODO automáticamente:

✅ Descarga el proyecto BCPOS
...
# Crear proyecto BCPOS desde cero (sin descargar)
...
$packageJson | Out-File -FilePath "$INSTALL_DIR\package.json" -Encoding UTF8
...
$prismaSchema | Out-File -FilePath "$INSTALL_DIR\prisma\schema.prisma" -Encoding UTF8
...
$indexPage | Out-File -FilePath "$INSTALL_DIR\src\pages\index.tsx" -Encoding UTF8
...
$envFile | Out-File -FilePath "$INSTALL_DIR\.env" -Encoding UTF8
